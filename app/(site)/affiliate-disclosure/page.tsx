  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-16">
      ...
      <div className="prose-base mt-10 space-y-6 leading-relaxed text-charcoal/85">
        <p>
          <strong>The short version:</strong> some of the links on this site are affiliate links.
          If you book or buy something through them, we may earn a small commission at no extra
          cost to you. We only recommend places, operators, and gear we&rsquo;d genuinely
          recommend to a friend. A commission never changes what we recommend or how we review it.
        </p>
        ...
        <p>
          An affiliate link is a regular hyperlink with a tracking parameter that tells the
          partner site you arrived from us. If you complete a booking or purchase, the partner
          pays us a small commission — usually a few percent of the booking value. You pay the
          same price you would pay if you went directly.
        </p>
        ...
        <ul className="mt-3 list-disc space-y-3 pl-6">
          ...
          <li>
            <strong>Agoda</strong> — accommodation. Often the best price for South-East Asian
            stays.
          </li>
          <li>
          ...
          <li>
            <strong>GetYourGuide</strong> — activity bookings (Green Canyon trips, day tours).
            Used selectively when an operator we trust is on the platform.
          </li>
          <li>
        ...
        <p>
          We label affiliate links and CTAs clearly:
        </p>
        <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            <code className="rounded bg-charcoal/8 px-1.5 py-0.5 font-[family-name:var(--font-mono)] text-[0.9em]">
        ...
        <p>
          We commit to four things:
        </p>
        <ul className="mt-3 list-disc space-y-2 pl-6">
          <li>
            We never write a positive review of a place we have not stayed at, eaten at, or done
            the activity at.
          </li>
          <li>
          ...
          <li>
            ...
            price tripled — we update or delist the recommendation, even if we&rsquo;ve been
        ...
        <p>
          ...
          we disclose any material connection between us and the products, services, or platforms
          we link to. The presence of any affiliate link should be considered a paid endorsement,
          even when we have personal experience with the product. Our opinions, however, remain
          our own.
        </p>
